...
""" % (prereq, q, q, prereq))
    ...
    print("Heuristic Explanation Points: ?/%d" % (posExplain))

    print('------------------')
    print('Total: %d/%d (%d/%d excluding style and explanation)' % (self.points.totalCount(), sumMax+posBonus1+posBonus2+posExplain,self.points.totalCount(), sumMax))
